...
async function main () {
  ...
  for (const f of ['background-menu.js', 'start-server.cjs', 'watchdog.cjs', 'server-config.js', 'inject.js', 'inspector-service.cjs', 'inspector-service-runner.cjs', 'updates.cjs', 'velopack-helper.cjs']) {
