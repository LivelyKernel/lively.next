...
System.registerDynamic("lively.ast/node_modules/lively.lang/lib/object.js", ["./base"], true, function($__require, exports, module) {
  ;
  var define,
      global = this,
      GLOBAL = this;
    ...
    var obj = exports.obj = {
        ...
        for (var i = 1; i < arguments.length; i++) {
          ...
          for (var property in source) {
            ...
            if (typeof sourceObj === "function") {
              if ((!sourceObj.name || (sourceObj.name.length == 0)) && !sourceObj.displayName)
      ...
      inspect: function inspect(object, options, depth) {
        ...
        var printedPropsJoined = printedProps.join(', '),
            useNewLines = (!isArray || options.newLineInArrays) && (!options.minLengthForNewLine || printedPropsJoined.length >= options.minLengthForNewLine),
  ...
  })(typeof $__require !== "undefined" && typeof exports !== "undefined" ? $__require('./base') : (typeof lively !== "undefined" && lively.lang ? lively.lang : {}));
  return module.exports;
});

System.registerDynamic("lively.ast/node_modules/lively.lang/lib/class.js", ["./base"], true, function($__require, exports, module) {
  ;
  var define,
      global = this,
      GLOBAL = this;
  ...
  (function(exports) {
    ...
    var classHelper = exports.classHelper = {
      ...
      initializer: function initializer() {
        ...
        if (firstArg && firstArg.isInstanceRestorer) {} else {
...
System.registerDynamic("lively.ast/node_modules/lively.lang/lib/collection.js", ["./base"], true, function($__require, exports, module) {
  ;
  var define,
      global = this,
      GLOBAL = this;
  ...
  (function(exports) {
    ...
    var arr = exports.arr = {
      ...
      zip: function() {
        var args = arr.from(arguments),
            array = args.shift(),
            iterator = typeof arr.last(args) === 'function' ? args.pop() : function(x) {
              return x;
            },
    ...
    var interval = exports.interval = {
      ...
      intervalsInRangeDo: function(start, end, intervals, iterator, mergeFunc, context) {
        ...
        if (start < end)
          collected.push(iterator.call(context, [start, end], true));
        return collected;
      },
      ...
      benchmark: function() {
        ...
        return ["Friday, 20. July 2012:", "coalesceOverlapping: 0.0003ms", "intervalsInbetween: 0.002ms", "mapToMatchingIndexes: 0.02ms", 'vs.\n' + new Date() + ":", benchmarkFunc("coalesceOverlapping", [[[9, 10], [1, 8], [3, 7], [15, 20], [14, 21]]], 100000), benchmarkFunc("intervalsInbetween", [0, 10, [[8, 10], [0, 2], [3, 5]]], 100000), benchmarkFunc("mapToMatchingIndexes", [Array.range(0, 1000).collect(function(n) {
          return [n, n + 1];
        }), [[4, 8], [500, 504], [900, 1004]]], 1000)].join('\n');
      }
    };
...
System.registerDynamic("lively.ast/node_modules/lively.lang/lib/sequence.js", ["./base"], true, function($__require, exports, module) {
  ;
  var define,
      global = this,
      GLOBAL = this;
  ...
  (function(exports) {
    "use strict";
    var seq = exports.seq = {take: function(gen, n) {
        var it = gen(),
            vals = [];
        for (var i = 0; i < n; i++) {
          var step = it.next();
...
System.registerDynamic("lively.ast/node_modules/lively.lang/lib/tree.js", ["./base"], true, function($__require, exports, module) {
  ;
  var define,
      global = this,
      GLOBAL = this;
...
System.registerDynamic("lively.ast/node_modules/lively.lang/lib/function.js", ["./base"], true, function($__require, exports, module) {
  ;
  var define,
      global = this,
      GLOBAL = this;
    ...
    var fun = exports.fun = {
      ...
      throttle: function(func, wait) {
        var context,
            ...
            more,
            result,
            whenDone = fun.debounce(wait, function() {
      ...
      asScriptOf: function(f, obj, optName, optMapping) {
        ...
        var proto = Object.getPrototypeOf(obj),
            mapping = {"this": obj};
        if (optMapping)
          mapping = exports.obj.merge([mapping, optMapping]);
        if (proto && proto[name]) {
...
System.registerDynamic("lively.ast/node_modules/lively.lang/lib/string.js", ["./base"], true, function($__require, exports, module) {
  ;
  var define,
      global = this,
      GLOBAL = this;
...
System.registerDynamic("lively.ast/node_modules/lively.lang/lib/number.js", ["./base"], true, function($__require, exports, module) {
  ;
  var define,
      global = this,
      GLOBAL = this;
...
System.registerDynamic("lively.ast/node_modules/lively.lang/lib/date.js", ["./base"], true, function($__require, exports, module) {
  ;
  var define,
      global = this,
      GLOBAL = this;
...
System.registerDynamic("lively.ast/node_modules/lively.lang/lib/promise.js", ["./base"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define,
      global = this,
  ...
  (function(exports) {
    ...
    obj.extend(exports.promise, {
      delay: function delay(ms, resolveVal) {
        return new Promise(function(resolve) {
          setTimeout(resolve, ms, resolveVal);
        });
      },
      delayReject: function delayReject(ms, rejectVal) {
        return new Promise(function(_, reject) {
          setTimeout(reject, ms, rejectVal);
        });
      },
      timeout: function timeout(ms, promise) {
      ...
      convertCallbackFun: function convertCallbackFun(func) {
      ...
      convertCallbackFunWithManyArgs: function convertCallbackFunWithManyArgs(func) {
        return function promiseGenerator() {
          var _this2 = this;
          var args = arr.from(arguments);
          return new Promise(function(resolve, reject) {
      ...
      chain: function chain(promiseFuncs) {
        return new Promise(function(resolve, reject) {
...
System.registerDynamic("lively.ast/node_modules/lively.lang/lib/events.js", ["events", "util", "./base"], true, function($__require, exports, module) {
  ;
  var define,
      global = this,
      GLOBAL = this;
  ...
  (function(exports) {
    "use strict";
    var isNode = typeof process !== 'undefined' && process.versions && process.versions.node;
    var events = exports.events = {makeEmitter: isNode ? function(obj) {
        if (obj.on && obj.removeListener)
          return obj;
        var events = $__require('events');
        $__require('util')._extend(obj, events.EventEmitter.prototype);
...
System.registerDynamic("lively.ast/node_modules/lively.lang/lib/graph.js", ["./base"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define,
      global = this,
  ...
  (function(exports) {
    ...
    var graph = exports.graph = {
      clone: function clone(graph) {
        var cloned = {};
        for (var id in graph)
          cloned[id] = graph[id].slice();
        return cloned;
      },
      without: function without(graph, ids) {
        var cloned = {};
        for (var id in graph) {
          if (ids.indexOf(id) > -1)
            continue;
      ...
      hull: function hull(graphMap, id, ignore, maxDepth) {
        return arr.uniq(arr.flatten(obj.values(graph.subgraphReachableBy(graphMap, id, ignore, maxDepth))));
      },
      subgraphReachableBy: function subgraphReachableBy(graphMap, id, ignore, maxDepth) {
...
System.registerDynamic("lively.ast/node_modules/lively.lang/lib/messenger.js", ["./base"], true, function($__require, exports, module) {
  ;
  var define,
      global = this,
      GLOBAL = this;
...
System.registerDynamic("lively.ast/node_modules/lively.lang/lib/base.js", [], true, function($__require, exports, module) {
  ;
  var define,
      global = this,
      GLOBAL = this;
  ...
  (function(Global) {
    var globalInterfaceSpec = [{
      ...
      sources: ["date"],
      methods: ["equals", "format", "relativeTo"]
    }, {
      action: "installMethods",
      target: "Function",
      sources: ["fun"],
      ...
      sources: ["fun"],
      methods: ["addToObject", "argumentNames", "asScript", "asScriptOf", "binds", "curry", "delay", "functionNames", "localFunctionNames", "getOriginal", "getVarMapping", "logCalls", "logCompletion", "logErrors", "qualifiedMethodName", "setProperty", "traceCalls", "wrap"]
    }, {
      action: "installMethods",
      target: "Number",
      sources: ["num"],
      ...
      sources: ["num"],
      methods: ["detent", "randomSmallerInteger", "roundTo", "toDegrees", "toRadians"]
    }, {
      action: "installMethods",
      target: "Object",
      sources: ["obj"],
      methods: ["addScript", "clone", "deepCopy", "extend", "inherit", "isArray", "isBoolean", "isElement", "isEmpty", "isFunction", "isNumber", "isObject", "isRegExp", "isString", "isUndefined", "merge", "mergePropertyInHierarchy", "values", "valuesInPropertyHierarchy"]
    }, {
      action: "installMethods",
      ...
      sources: ["string"],
      methods: ["camelize", "capitalize", "digitValue", "empty", "endsWith", "hashCode", "include", "pad", "regExpEscape", "startsWith", "startsWithVowel", "succ", "times", "toArray", "toQueryParams", "truncate"]
    }, {
      action: "installMethods",
      target: "Function.prototype",
      sources: ["class"],
      ...
      action: "installObject",
      target: "Numbers",
      source: "num",
      methods: ["average", "between", "convertLength", "humanReadableByteSize", "median", "normalRandom", "parseLength", "random", "sort"]
    }, {
      action: "installObject",
      target: "Properties",
      source: "properties",
      methods: ["all", "allOwnPropertiesOrFunctions", "allProperties", "any", "forEachOwn", "hash", "nameFor", "own", "ownValues", "values"]
    }, {
      action: "installObject",
      target: "Strings",
      source: "string",
      methods: ["camelCaseString", "createDataURI", "diff", "format", "formatFromArray", "indent", "lineIndexComputer", "lines", "md5", "newUUID", "nonEmptyLines", "pad", "paragraphs", "peekLeft", "peekRight", "print", "printNested", "printTable", "printTree", "quote", "reMatches", "removeSurroundingWhitespaces", "stringMatch", "tableize", "tokens", "unescapeCharacterEntities", "withDecimalPrecision"]
    }, {
      action: "installObject",
      target: "Objects",
      source: "obj",
      methods: ["asObject", "equals", "inspect", "isMutableType", "safeToString", "shortPrintStringOf", "typeStringOf"]
    }, {
      action: "installObject",
      target: "Functions",
      source: "fun",
      methods: ["all", "compose", "composeAsync", "createQueue", "debounce", "debounceNamed", "either", "extractBody", "flip", "notYetImplemented", "once", "own", "throttle", "throttleNamed", "timeToRun", "timeToRunN", "waitFor", "workerWithCallbackQueue", "wrapperChain"]
    }, {
      action: "installObject",
      target: "Grid",
      source: "grid"
      ...
      action: "installObject",
      target: "lively.ArrayProjection",
      source: "arrayProjection"
    }, {
      action: "installObject",
      target: "lively.Closure",
      source: "Closure"
    }, {
      action: "installObject",
      target: "lively.Grouping",
      source: "Group"
    }, {
      action: "installObject",
      target: "lively.PropertyPath",
      source: "Path"
    }, {
      action: "installObject",
      target: "lively.Worker",
      source: "worker"
    }, {
      action: "installObject",
      target: "lively.Class",
    ...
    function chain(object) {
      ...
      var chained;
      if (Array.isArray(object))
        return createChain(livelyLang.arr, object);
      if (object.constructor.name === "Date")
        return createChain(livelyLang.date, object);
      switch (typeof object) {
        case 'string':
          return createChain(livelyLang.string, object);
        case 'object':
          return createChain(livelyLang.obj, object);
        case 'function':
          return createChain(livelyLang.fun, object);
        case 'number':
          return createChain(livelyLang.num, object);
      }
    ...
    function installGlobals() {
      globalInterfaceSpec.forEach(function(ea) {
        if (ea.action === "installMethods") {
          ...
          throw new Error("Cannot deal with global setup action: " + ea.action);
      });
    }
...
System.registerDynamic("lively.ast/node_modules/lively.lang/lib/worker.js", ["path", "os", "fs", "child_process", "util", "./base"], true, function($__require, exports, module) {
  ;
  var define,
      global = this,
      GLOBAL = this;
  ...
  (function(exports) {
    "use strict";
    var isNodejs = typeof $__require !== 'undefined' && typeof process !== 'undefined';
    var WorkerSetup = {
      ...
      loadDependenciesNodejs: function loadDependenciesNodejs(options) {
        ...
        lv.lang = $__require($__require('path').join(options.libLocation, "index"));
      },
    ...
    var BrowserWorker = {create: function(options) {
        options = options || {};
...
System.registerDynamic("lively.ast/node_modules/lively.lang/index.js", ["./lib/base", "./lib/object", "./lib/class", "./lib/collection", "./lib/sequence", "./lib/tree", "./lib/function", "./lib/string", "./lib/number", "./lib/date", "./lib/promise", "./lib/events", "./lib/graph", "./lib/messenger", "./lib/worker"], true, function($__require, exports, module) {
  ;
  var define,
      global = this,
      GLOBAL = this;
  var livelyLang = $__require('./lib/base');
  $__require('./lib/object');
  $__require('./lib/class');
  $__require('./lib/collection');
  $__require('./lib/sequence');
  $__require('./lib/tree');
  $__require('./lib/function');
  $__require('./lib/string');
  $__require('./lib/number');
  $__require('./lib/date');
  $__require('./lib/promise');
  $__require('./lib/events');
  $__require('./lib/graph');
  $__require('./lib/messenger');
  $__require('./lib/worker');
  module.exports = livelyLang;
  return module.exports;
});
...
System.config({
  ...
  "bundles": {
    "lively.ast": [
      ...
      "lively.ast/node_modules/lively.lang/lib/base.js",
      "lively.ast/generated/estree-visitor.js",
      "lively.ast/node_modules/lively.lang/lib/object.js",
      "lively.ast/node_modules/lively.lang/lib/class.js",
      "lively.ast/node_modules/lively.lang/lib/collection.js",
      "lively.ast/node_modules/lively.lang/lib/sequence.js",
      "lively.ast/node_modules/lively.lang/lib/tree.js",
      "lively.ast/node_modules/lively.lang/lib/string.js",
      "lively.ast/node_modules/lively.lang/lib/function.js",
      "lively.ast/node_modules/lively.lang/lib/number.js",
      "lively.ast/node_modules/lively.lang/lib/date.js",
      "lively.ast/node_modules/lively.lang/lib/promise.js",
      "lively.ast/node_modules/lively.lang/lib/events.js",
      "lively.ast/node_modules/lively.lang/lib/graph.js",
      "lively.ast/node_modules/lively.lang/lib/messenger.js",
      "lively.ast/node_modules/lively.lang/lib/worker.js"
    ]
  }
});