...
System.register('lively.ast/lib/mozilla-ast-visitor-interface.js', [
    ...
    'use strict';
    var string, Path, BaseVisitor, PrinterVisitor, ComparisonVisitor, stringify, addSource, addAstIndex, parse, methods, withMozillaAstDo, printAst, compareAst, pathToNode, rematchAstWithSource;
    return {
        setters: [
            ...
            function (_acornExtensionJs) {
                addSource = _acornExtensionJs.addSource;
                addAstIndex = _acornExtensionJs.addAstIndex;
            },
            function (_parserJs) {
...
System.register('lively.ast/lib/parser.js', [
    ...
    'use strict';
    var arr, acorn, loose, addSource, addAstIndex, toLKObjects, findNodesIncluding;
    function parse(source, options) {
        ...
        var ast = options.addSource ? addSource(source, options) : acorn.parse(source, options);
    ...
    return {
        setters: [
            ...
            function (_acornExtensionJs) {
                ...
                addSource = _acornExtensionJs.addSource;
                addAstIndex = _acornExtensionJs.addAstIndex;
                toLKObjects = _acornExtensionJs.toLKObjects;
                findNodesIncluding = _acornExtensionJs.findNodesIncluding;
            }
        ],
        execute: function () {
            _export('parse', parse);
...
System.register('lively.ast/lib/acorn-extension.js', [
    ...
    'use strict';
    var obj, arr, string, Path, withMozillaAstDo, GLOBAL, walk, loose;
    ...
    function findSiblings(parsed, node, beforeOrAfter) {
        if (!node)
            return [];
        var nodes = findNodesIncluding(parsed, node.start), idx = nodes.indexOf(node), parents = nodes.slice(0, idx), parentWithBody = arr.detect(parents.reverse(), function (p) {
    ...
    return {
        ...
        execute: function () {
            ...
            _export('findStatementOfNode', findStatementOfNode);
            _export('addSource', addSource);
            _export('addAstIndex', addAstIndex);
            _export('toLKObjects', toLKObjects);
            _export('findNodesIncluding', findNodesIncluding);
            _export('findSiblings', findSiblings);
            _export('findNodeByAstIndex', findNodeByAstIndex);
            _export('copy', copy);
            ;
            ;
            ;
...
System.register('lively.ast/lib/comments.js', [
    ...
    'use strict';
    var obj, string, Path, chain, arr, withMozillaAstDo, parse, findStatementOfNode, stringify;
    function getCommentPrecedingNode(parsed, node) {
        var statementPath = findStatementOfNode({ asPath: true }, parsed, node), blockPath = statementPath.slice(0, -2), block = Path(blockPath).get(parsed);
    ...
    return {
        setters: [
            ...
            function (_acornExtensionJs) {
                findStatementOfNode = _acornExtensionJs.findStatementOfNode;
            },
            function (_stringifyJs) {
                stringify = _stringifyJs['default'];
            }
    ...
    return {
        ...
        execute: function () {
            ...
            obj.extend(ScopeVisitor.prototype, 'scope specific', {
                ...
                visitThisExpression: function visitThisExpression(node, depth, scope, path) {
...
System.registerDynamic('lively.ast/dist/acorn.js', [], false, function(require, exports, module) {
...
System.register('lively.ast/generated/estree-visitor.js', [], function (_export) {
    'use strict';
    'format esm';
    function Visitor() {
    }
        ...
        execute: function () {
            ...
            Visitor.prototype.visitProgram = function visitProgram(node, state, path) {
                ...
                node['body'] = node['body'].reduce(function (results, ea, i) {
                    var result = visitor.accept(ea, state, path.concat([
                        'body',
                        i
                    ]));
