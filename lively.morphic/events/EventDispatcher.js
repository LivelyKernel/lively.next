...
export default class EventDispatcher {
  ...
  processDOMEvent(domEvt, targetMorph) {
    ...
    var type         = domEvt.type,
        ...
        hand         = typeof pointerId === "number" ? this.world.handForPointerId(pointerId, domEvt.isPrimary) : this.world.firstHand,
        halo         = typeof pointerId === "number" && !touch ? this.world.haloForPointerId(pointerId) : null,
        layoutHalo   = typeof pointerId === "number" && !touch ? this.world.layoutHaloForPointerId(pointerId) : null,
