...
export class MorphicDBPrompt extends AbstractPrompt {
  ...
  initLayout (showAlias = false) {
    ...
    this.layout = new ConstraintLayout({
      submorphConstraints: [
        ['alias label', { typeX: 'left', typeX: 'top' }],
        ['server url label', { typeX: 'left', typeX: 'top' }],
        ['snapshot location label', { typeX: 'left', typeX: 'top' }],
        ['dbname label', { typeX: 'left', typeX: 'top' }],
        ['alias input', { typeX: 'left-right', typeY: 'top' }],
        ['server url input', { typeX: 'left-right', typeY: 'top' }],
        ['snapshot location input', { typeX: 'left-right', typeY: 'top' }],
        ['dbname input', { typeX: 'left-right', typeY: 'top' }]
      ]
    });
  }
}
