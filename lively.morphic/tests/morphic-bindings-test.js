/* global it, describe, beforeEach, afterEach, xdescribe */
...
let describInBrowser = System.get('@system-env').browser
  ? describe
...
describInBrowser('morphic bindings', function () {
  beforeEach(function () {
    ...
    connect(sut, 'position', sut.text, 'textString', { converter: pos => String(pos) }).update(pt(0, 0));
