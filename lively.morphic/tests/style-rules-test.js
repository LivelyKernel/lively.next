...
describe('Style Rules', function () {
  ...
  beforeEach(async () => await MorphicEnv.pushDefault(new MorphicEnv(await createDOMEnvironment())).setWorld(createDummyWorld()));
  ...
  it('applies a style once a morph is added to the hierarchy', () => {
    const m1 = new Morph({ styleClasses: ['root'] }); const m2 = new Morph({ styleClasses: ['child'] });
    m1.styleSheets = new StyleSheet({
      '.root': { fill: Color.orange },
  ...
  it('updates the style once a morph is added', () => {
    ...
    const m2 = new Morph({ styleClasses: ['child'] });
    const m3 = new Morph({ styleClasses: ['leaf'] });
  ...
  it('can be nested', () => {
    ...
    const m2 = new Morph({ name: 'm2', styleClasses: ['child'] });
    const m3 = new Morph({ name: 'm3', styleClasses: ['child'] });
  ...
  it('updates all affected morphs if style sheet rules are changed', () => {
    let sheet; let hierarchy = new Morph({
      styleSheets: [
