var config = {
  ...
  globalKeyBindings: [
    ...
    {keys: "Left", command: {command: "move halo target", args: {direction: "left"}}},
    {keys: "Right", command: {command: "move halo target", args: {direction: "right"}}},
    {keys: "Up", command: {command: "move halo target", args: {direction: "up"}}},
    {keys: "Down", command: {command: "move halo target", args: {direction: "down"}}},  
    {keys: "Meta-Left", command: {command: "move halo target", args: {direction: "left", offset: 10}}},
    {keys: "Meta-Right", command: {command: "move halo target", args: {direction: "right", offset: 10}}},
    {keys: "Meta-Up", command: {command: "move halo target", args: {direction: "up", offset: 10}}},
    {keys: "Meta-Down", command: {command: "move halo target", args: {direction: "down", offset: 10}}},
    {keys: "Alt-Left", command: {command: "move halo target", args: {direction: "left", offset: 100}}},
    {keys: "Alt-Right", command: {command: "move halo target", args: {direction: "right", offset: 100}}},
    {keys: "Alt-Up", command: {command: "move halo target", args: {direction: "up", offset: 100}}},
    {keys: "Alt-Down", command: {command: "move halo target", args: {direction: "down", offset: 100}}},

    {keys: "Shift-Left",  command: {command: "resize halo target", args: {direction: "left"}}},
    {keys: "Shift-Right", command: {command: "resize halo target", args: {direction: "right"}}},
    {keys: "Shift-Up",    command: {command: "resize halo target", args: {direction: "up"}}},
    {keys: "Shift-Down",  command: {command: "resize halo target", args: {direction: "down"}}},  
    {keys: "Meta-Shift-Left",  command: {command: "resize halo target", args: {direction: "left", amount: 10}}},
    {keys: "Meta-Shift-Right", command: {command: "resize halo target", args: {direction: "right", amount: 10}}},
    {keys: "Meta-Shift-Up",    command: {command: "resize halo target", args: {direction: "up", amount: 10}}},
    {keys: "Meta-Shift-Down",  command: {command: "resize halo target", args: {direction: "down", amount: 10}}},
    {keys: "Alt-Shift-Left",   command: {command: "resize halo target", args: {direction: "left", amount: 100}}},
    {keys: "Alt-Shift-Right",  command: {command: "resize halo target", args: {direction: "right", amount: 100}}},
    {keys: "Alt-Shift-Up",     command: {command: "resize halo target", args: {direction: "up", amount: 100}}},
    {keys: "Alt-Shift-Down",   command: {command: "resize halo target", args: {direction: "down", amount: 100}}},
  ],
  text: {
    cursorBlinkPeriod: .5,
    useSoftTabs: true,
