    ...
    case "default":
      ...
      if (c === "}") {
        if (this.levels.length === 1 && this.levels[0] <= 0) {
          ...
          this.levels.length > 1 && this.levels[this.levels.length - 1] === 1
        ) {
          this.levels.pop();
          this.state = "template";
        } else {
...
import JSTokenizer from "lively.morphic/ide/js/highlighter.js";
var tokenizer = new JSTokenizer(),
    src = await lively.modules.module("lively.morphic/morph.js").source();
