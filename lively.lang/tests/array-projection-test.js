...
describe('array projection', function () {
  it('creates projection', function () {
    ...
    let array = range(65, 74).map(i => String.fromCharCode(i));
  ...
  it('gets projection in range', function () {
    // array = ["A","B","C","D","E","F","G","H","I","J"]
    let array = range(65, 74).map(i => String.fromCharCode(i));
    let projection = { array: array, from: 5, to: 8 };
    let result = toArray(projection);
  ...
  it('transforms projection to include index', function () {
    ...
    var projection = create(array, 3, 2);
    ...
    // -=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-
    var array = [1, 2, 3, 4, 5]; var projection = create(array, 3);
