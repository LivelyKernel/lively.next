...
describe('interval', function () {
  ...
  it('compares intervals', function () {
    ...
    for (let i = 0; i < inputAndExpected.length; i += 3) {
      let expected = inputAndExpected[i + 2];
      let a = inputAndExpected[i + 0];
      let b = inputAndExpected[i + 1];
  ...
  it('coalesces any number of overlapping intervals', function () {
    ...
    // with merge func
    let result = coalesceOverlapping(
      [[3, 5, 'b'], [1, 4, 'a'], [8, 10, 'c']],
  ...
  it('finds matching intervals', function () {
    let existingIntervals = [[1, 4], [4, 5], [5, 8], [9, 20]];
    let test = this; let testTable = [
  ...
  it('merges overlapping intervals', function () {
    ...
    for (let i = 0; i < inputsAndExpected.length; i++) {
      let expected = inputsAndExpected[i].expected;
      let a = inputsAndExpected[i].a;
      let b = inputsAndExpected[i].b;
