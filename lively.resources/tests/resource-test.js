...
describe('http', function () {
  ...
  it('can create a new file', async () => {
    const r = resource(testProjectDir + 'new-file.js');
  ...
  it('cannot write a dir', async () => {
    const r = resource(testProjectDir + 'new-sub-dir/');
    try {
      await r.write('hello world');
    } catch (e) {
...
describe('url operations', () => {
  it('is parent', () => {
    const r1 = resource('http://foo/bar/oink/baz.js');
    const r2 = resource('http://foo/bar/');
  ...
  it('common directory', () => {
    const r1 = resource('http://foo/bar/oink/baz.js');
    const r2 = resource('http://foo/bar/zork.js');
    const r3 = resource('https://foo/bar/zork.js');
    const r4 = resource('http://foo/zork.js');
    const r5 = resource('http://foo');
  ...
  it('relativePathBetween', () => {
    ...
    const a = 'http://northwestern.itsapirateslife.net:9001/core/lively/bootstrap.js';
    const b = 'http://northwestern.itsapirateslife.net:9001//questions/Worlds/unknown_user_1434404507629_original.html?autosave=true';
