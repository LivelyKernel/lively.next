...
function ESCODEGEN () {
  ...
  function isExpression (node) {
    return CodeGenerator.Expression.hasOwnProperty(node.type); // eslint-disable-line no-use-before-define
  }

  // Generation is done by generateStatement.
  function isStatement (node) {
    return CodeGenerator.Statement.hasOwnProperty(node.type); // eslint-disable-line no-use-before-define
  }
  ...
  function escapeString (str) {
    let result = ''; let i; let len; let code; let singleQuotes = 0; let doubleQuotes = 0; let single; let quote;
  ...
  function flattenToString (arr) {
    let i; let iz; let elem; let result = '';
  ...
  CodeGenerator.prototype.maybeBlock = function (stmt, flags) {
    let result; let noLeadingComment; let that = this;
  ...
  function generateMethodPrefix (prop) {
    let func = prop.value; let prefix = '';
    if (func.async) {
  ...
  CodeGenerator.prototype.generateIterationForStatement = function (operator, stmt, flags) {
    let result = ['for' + (stmt.await ? noEmptySpace() + 'await' : '') + space + '(']; let that = this;
    withIndent(function () {
  ...
  CodeGenerator.Statement = {
    ...
    BlockStatement: function (stmt, flags) {
      let range; let content; let result = ['{', newline]; let that = this;
    ...
    ClassBody: function (stmt, flags) {
      let result = ['{', newline]; let that = this;
    ...
    ExportDefaultDeclaration: function (stmt, flags) {
      let result = ['export']; let bodyFlags;
    ...
    ExportNamedDeclaration: function (stmt, flags) {
      let result = ['export']; let bodyFlags; let that = this;
    ...
    ImportDeclaration: function (stmt, flags) {
      ...
      let result; let cursor; let that = this;
    ...
    VariableDeclaration: function (stmt, flags) {
      ...
      let result; let i; let iz; let node; let bodyFlags; let that = this;
    ...
    SwitchStatement: function (stmt, flags) {
      let result; let fragment; let i; let iz; let bodyFlags; let that = this;
      withIndent(function () {
        result = [
          'switch' + space + '(',
    ...
    IfStatement: function (stmt, flags) {
      let result; let bodyFlags; let semicolonOptional; let that = this;
      withIndent(function () {
        result = [
          'if' + space + '(',
  ...
  CodeGenerator.Expression = {
    ...
    ArrayExpression: function (expr, precedence, flags, isPattern) {
      let result; let multiline; let that = this;
    ...
    ObjectExpression: function (expr, precedence, flags) {
      let multiline; let result; let fragment; let that = this;
    ...
    ObjectPattern: function (expr, precedence, flags) {
      let result; let i; let iz; let multiline; let property; let that = this;
      if (!expr.properties.length) {
        return '{}';
      }
    ...
    ComprehensionExpression: function (expr, precedence, flags) {
      ...
      let result; let i; let iz; let fragment; let that = this;
  ...
  function generate (node, options) {
    let defaultOptions = getDefaultOptions(); let result; let pair;
