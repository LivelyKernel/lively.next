      ...
      bindings: {
        get () {
          return [
            ...
            { target: 'tabs', signal: 'onSelectedTabChange', handler: 'browsedTabChanged' },
            { target: 'tabs', signal: 'oneTabRemaining', handler: 'makeTabsNotCloseable' },
            { target: 'tabs', signal: 'becameVisible', handler: 'relayout' },
            { target: 'tabs', signal: 'becameInvisible', handler: 'relayout' },
