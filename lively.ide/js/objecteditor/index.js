...
export class ObjectEditorModel extends ViewModel {
    ...
    return [
...

      {
        ...
        exec: async () => {
          try {
            const { view } = this;
            const { success, reason } = await this.doSave();
   ...
   * FIXME: This still does not work well and interferes with auto positioning of the cursor from the system and manual selection.
   */
