...
describeInBrowser("text plugins", () => {
  ...
  it("triggered expansion with end position", () => {
    ...
    text.cursorPosition = {row: 0, column: 3};
    var snip = new Snippet({trigger: "foo", expansion: "$0bar"});
    var triggered = snip.tryTrigger(text);
  ...
  it("expansion with prefilled steps", () => {
    ...
    text.cursorPosition = {row: 0, column: 3};
    var snip = new Snippet({trigger: "foo", expansion: "bar${0:oi}zork${1:ui}"});
  ...
  it("triggered expansion with multiple steps", () => {
    ...
    text.cursorPosition = {row: 0, column: 3};
    var snip = new Snippet({trigger: "foo", expansion: "$2b$1a$0r"});
    var triggered = snip.tryTrigger(text);
