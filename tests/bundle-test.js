...
let baseDir = resource("local://freezer-tests/"), packages, bundle;
...
describe("bundler", function () {
  ...
  describe("bundle execution", () => {
    ...
    it("standalone", async () => {
      eval(await bundle.standalone({entryModule: "package1/file1.js"}));
      expect(lively.FreezerRuntime.get("package1@1/file1.js").exports)
        .deep.equals({y: 25,z: 99});
    });

    it("star import", async () => {      
      eval(await bundle.standalone({entryModule: "package1/file_star_import.js"}));
      expect(lively.FreezerRuntime.get("package1@1/file_star_import.js").exports)
        .deep.equals({file1: {y: 25,z: 99}});
    });

    it("star export", async () => {      
      eval(await bundle.standalone({entryModule: "package1/file_star_export.js"}));
      expect(lively.FreezerRuntime.get("package1@1/file_star_export.js").exports)
        .deep.equals({y: 25,z: 99});
    });
