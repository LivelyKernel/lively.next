...
describe("Authentication", () => {
  ...
  before(async () =>{
     ...
     await authserver.addUser("testUser2", "testuser2@lively-next.org", "test",'adminpassword')
     malleableUser = new user({name: 'testUser2', email: "testuser2@lively-next.org", password: 'test'})
     await malleableUser.authenticated(300);
  ...
  after(async () =>{
    ...
    await authserver.removeUser("testUser2", "testuser2@lively-next.org", 'adminpassword')
  })
