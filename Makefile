.PHONY: clear-esm-cache clear-headless-cache start install hooks docker-build-prepare docker-start docker-watch docker-bash docker-stop loading-screen landing-page clear-freezer-dir
clear-esm-cache:
	rm -rf esm_cache
	mkdir esm_cache
