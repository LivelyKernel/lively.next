...
export async function fillDB1 () {
  ...
  let author1 = { name: 'test-user-1' };
  let author2 = { name: 'test-user-2' };
  let objectDB;
  let part1; let commit5; let commit4; let commit3; let commit2; let world2; let commit1; let world1;
...
export async function fillDB2 () {
  let snapshotLocation = resource('local://lively-morphic-objectdb-test/snapshots/');
  let author1 = { name: 'test-user-1' }; let author2 = { name: 'test-user-2' };
  let objectDB;
  let part1; let commit5; let commit4; let commit3; let commit2; let world2; let commit1; let world1;
