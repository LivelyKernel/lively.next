...
export async function runEval(System, code, options) {
  ...
  var {format, targetModule, parentModule, parentAddress} = options;
  targetModule = await System.normalize(
    targetModule || "*scratch*",
    parentModule, parentAddress);
  ...
  var module = System.get("@lively-env").moduleEnv(targetModule),
      ...
      transpiler = await getEs6Transpiler(System, options, module),
