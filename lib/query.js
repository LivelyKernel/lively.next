...
var arr = lively.lang.arr, chain = lively.lang.chain;
...
exports.query = {
  ...
  scopeAtIndex: function(ast, index) {
    return exports.query.scopesAtIndex(ast, index).last();
  },
  ...
  topLevelDeclsAndRefs: function(ast, options) {
    ...
    var scope     = exports.query.scopes(ast),
      ...
      undeclared  = arr.pluck(refs, 'name').withoutAll(declared);
  ...
  findNodesIncludingLines: function(ast, code, lines, options) {
    ...
    if (lines.every(function(line) {
      return lively.lang.num.between(line, node.loc.start.line, node.loc.end.line); })) {
