...
import { obj, string, Path, chain, arr } from "lively.lang";
import { withMozillaAstDo } from "./mozilla-ast-visitor-interface.js";
import { parse } from "./parser.js";
import { walk } from "./acorn-extension.js";
import { escodegen } from "escodegen";

function getCommentPrecedingNode(parsed, node) {
  var statementPath = walk.findStatementOfNode({asPath: true}, parsed, node),
...
function extractComments(astOrCode, optCode) {
  var parsed = typeof astOrCode === "string" ?
      ...
      code = optCode ? optCode : (typeof astOrCode === "string" ?
        astOrCode : escodegen.generate(astOrCode)),
