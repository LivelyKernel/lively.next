...
import { capturing, fuzzyParse } from "lively.ast";
...
function transformForVarRecord(
  ...
  var undeclaredToTransform = recordGlobals ?
        null/*all*/ : arr.withoutAll(Object.keys(varRecorder), blacklist),
      transformed = capturing.rewriteToCaptureTopLevelVariables(
  ...
  if (defRangeRecorder) obj.extend(defRangeRecorder, transformed.defRanges);
  return code;
}
