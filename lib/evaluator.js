...
function transformForVarRecord(code, varRecorder, varRecorderName, blacklist, defRangeRecorder, recordGlobals, es6ModulesId, es6ExportId) {
  ...
  var undeclaredToTransform = recordGlobals ?
      ...
      transformed = ast.capturing.rewriteToCaptureTopLevelVariables(
        ...
        {es6ModulesId: es6ModulesId,
         es6ExportId: es6ExportId,
