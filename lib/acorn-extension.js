...
import * as acorn_module from "acorn/src/index.js";
import * as walk_module from "acorn/src/walk/index.js";
import * as loose_module from "acorn/src/loose/index.js";
import { withMozillaAstDo } from "./mozilla-ast-visitor-interface.js";

var walk = obj.extend({}, walk_module),
    loose = obj.extend({}, loose_module),
    acorn = obj.merge({walk: walk, loose: loose}, acorn_module);
