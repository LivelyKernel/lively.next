...
;(function(run) {
  ...
  var _escodegen = isCommonJS ? require("escodegen") : escodegen;
  ...
  run(_acorn, _escodegen, _lively, _livelyLang, _exports);
})(function(acorn, escodegen, lively, lang, exports) {

lively.lang.obj.extend(acorn, {
  ...
  rematchAstWithSource: function(ast, source, addLocations, subTreePath) {
    ...
    if (subTreePath) ast2 = lively.lang.Path(subTreePath).get(ast2);
