...
function generateResourceExtensionModule (frozenPart) {
  return `
    ...
    import { StyleGuideResource } from "lively.morphic/components/policy.js";
...
export async function generateLoadHtml (part, format = 'global') {
  ...
  html += addScripts;
  html += `</head>
<body style="margin: 0; overflow-x: hidden; width: 100%; height: 100%;"><div id="loading-screen">${part.__loading_html__ || ''}</div><div id="crawler content">${part.__crawler_html__ || ''}</div>
